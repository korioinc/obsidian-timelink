import {
	...
	type EventFormDraft,
	type EventFormProps,
} from '../event-form/EventFormModal';
import type { CreateEventState, EventModalState } from '../event/types';
...
const buildEditProps = (
	...
	handlers: Pick<UseEventModalsProps, 'onEditSave' | 'onEditDelete' | 'onOpenNote' | 'onCloseEdit'>,
): EventFormProps => {
	return {
...
const buildCreateProps = (
	...
	controller: ModalController,
	handlers: Pick<UseEventModalsProps, 'onCreateSave' | 'onCloseCreate'>,
): EventFormProps => {
	return {
...
export const useEventModals = ({
	...
	}, [app, modal, onEditDelete, onEditSave, onOpenNote, onCloseEdit]);
	...
	}, [app, createModal, onCloseCreate, onCreateSave]);
};
