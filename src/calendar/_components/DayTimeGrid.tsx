...
import type { EventSegment, TimedEventPlacement, TimeSelectionRange } from '../types';
				...
				>
							...
							<div
								...
								style={{
									...
									height: `${
										(Math.max(
											0,
											(timedDragEndMinutes ?? MINUTES_IN_DAY) - timedDragRange.startMinutes,
										) /
											SLOT_MINUTES) *
										SLOT_HEIGHT
									}px`,
					...
					{timedEvents.map((placement) => {
						...
						if (isResizingEvent && timedResizeRange) {
							const resizeRangeStartKey =
								compareDateKey(timedResizeRange.startDateKey, timedResizeRange.endDateKey) <= 0
									? timedResizeRange.startDateKey
									: timedResizeRange.endDateKey;
							const resizeRangeEndKey =
								compareDateKey(timedResizeRange.startDateKey, timedResizeRange.endDateKey) <= 0
									? timedResizeRange.endDateKey
									: timedResizeRange.startDateKey;
